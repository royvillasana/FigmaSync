// =============================================================================
// Design Token types — W3C DTCG format
// =============================================================================
...
export interface StyleDictionaryOutputs {
  css: string;       // tokens/css/variables.css
  tailwind: string;  // tokens/tailwind/config.ts
  typescript: string; // tokens/js/tokens.ts
  scss: string;      // tokens/scss/variables.scss
  json: string;      // tokens/json/flat.json
}
